...
export const images: GalleryImage[] = [
  ...
  { src: '/images/gallery/04.webp', alt: 'Chambre double dans résidence au calme pour un repos serein',    altEn: 'Quiet double bedroom with two bedside lamps',                      section: 'chambre'        },
  { src: '/images/gallery/05.webp', alt: 'Salle de bain fonctionnelle',                                    altEn: 'Fully equipped kitchen and bathroom',                              section: 'cuisine'        },
  ...
  { src: '/images/gallery/08.webp', alt: 'Boulangerie, boucherie et tous commerces à proximité',           altEn: 'Bakery, butcher and shops a short walk away',                      section: 'commerces'      },
